...
class AgoraTTSService:
    ...
    def _configure_elevenlabs(self) -> None:
        ...
        self.default_voice = self.default_voice or cfg.voice_id
    ...
    async def synthesize_speech(
        ...
        try:
            if self.provider == "openai":
                return await self._synthesize_openai(text, voice, audio_format)
            if self.provider == "elevenlabs":
                return await self._synthesize_elevenlabs(text, voice, audio_format)
